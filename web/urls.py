...
from web.views import cart,orders,views

urlpatterns = [
    path('', views.index, name="index"),
    path("selectshop",views.selectshop,name='selectshop'),#选择店铺页面
    path('buy/<str:shopid>',views.buy, name='buy'),#店铺点餐页面
    path('sign_in',views.Login.as_view(),name='sign_in'),#登录
    path('register', views.Register.as_view(), name='register'),#注册
    path('logout', views.logout, name="web_logout"),  # 退出
    path('buy',views.webindex,name='web_index'),
    ...
    path("web/",include([
        ...
        path('mycenter',views.mycenter,name ="web_mycenter"), #个人中心
        #购物车信息管理路由
